...
namespace Microsoft.BotBuilderSamples.Dialog
{
    ...
    public class QnAMakerBaseDialog : QnAMakerDialog
    {
        ...
        public const string DefaultNoAnswer = "Przepraszam, ale chyba nie rozumiem pytania.\n\nMożesz spróbować skorzystać z następującej konstrukcji: \"**Gdzie mam wyrzucić <nazwa odpadu>?**\".\n\nJeżeli nadal nie otrzymasz odpowiedzi, prawdopodobnie nie znam odpowiedzi na Twoje pytanie. Dziękuję za zrozumienie!\n\nChcąc zobaczyć listę przykładowych pytań, zadaj mi następujące pytanie: \"**O co mogę się Ciebie zapytać?**\".";
